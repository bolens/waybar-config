...
APPICON_VERSION="${APPICON_VERSION:-v0.1.0}"
# SHA256 of release archives (from https://github.com/bolens/appicon/releases).
APPICON_SHA256_AMD64="${APPICON_SHA256_AMD64:-788b3f294a034e94b36c5420a08f132f054fcaeec6c17006092798f3a4fb95e8}"
APPICON_SHA256_ARM64="${APPICON_SHA256_ARM64:-ed1bbd810a329654c50feb05a6e7d97526774a8809c29ac16e43c649075b1f1c}"
